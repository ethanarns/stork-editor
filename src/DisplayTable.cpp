    ...
    for (int colIndex = 0; colIndex < CELL_LIST_SIZE; colIndex++) {
        ...
        switch ((CollisionType)curCol) {
            ...
            case CollisionType::UPSIDE_DOWN_SHARP_UP_1: {
                ...
                this->setCellCollision(y,  x+1,CollisionDraw::CLEAR, curCol);
                this->setCellCollision(y+1,x,  CollisionDraw::UPSIDE_DOWN_SHARP_UP_SHORT_DRAW, curCol);
                this->setCellCollision(y+1,x+1,CollisionDraw::CLEAR, curCol);
                break;
            }
            ...
            case CollisionType::PASSABLE_DOWN_RIGHT_30_1: { // 0x55
                this->setCellCollision(y,  x,  CollisionDraw::DOWN_RIGHT_30_SHORT, curCol);
                this->setCellCollision(y,  x+1,CollisionDraw::CLEAR, curCol);
                this->setCellCollision(y+1,x,  CollisionDraw::ZIG_ZAG, curCol);
                this->setCellCollision(y+1,x+1,CollisionDraw::DOWN_RIGHT_30_TALL, curCol);
                break;
            }
            case CollisionType::PASSABLE_DOWN_RIGHT_30_2: { // 0x54
                this->setCellCollision(y,  x,  CollisionDraw::CLEAR, curCol);
                this->setCellCollision(y,  x+1,CollisionDraw::CLEAR, curCol);
                this->setCellCollision(y+1,x,  CollisionDraw::ZIG_ZAG, curCol);
                this->setCellCollision(y+1,x+1,CollisionDraw::DOWN_RIGHT_30_SHORT, curCol);
            ...
            case CollisionType::PASSABLE_UP_RIGHT_30_1: { // 0x14
                this->setCellCollision(y,  x,  CollisionDraw::CLEAR, curCol);
                this->setCellCollision(y,  x+1,CollisionDraw::CLEAR, curCol);
                this->setCellCollision(y+1,x,  CollisionDraw::UP_RIGHT_30_BL, curCol);
                this->setCellCollision(y+1,x+1,CollisionDraw::ZIG_ZAG, curCol);
            ...
            case CollisionType::PASSABLE_UP_RIGHT_30_2: { // 0x15
                this->setCellCollision(y,  x,  CollisionDraw::CLEAR, curCol);
                this->setCellCollision(y,  x+1,CollisionDraw::UP_RIGHT_30_BL, curCol);
                this->setCellCollision(y+1,x,  CollisionDraw::UP_RIGHT_30_BR, curCol);
                this->setCellCollision(y+1,x+1,CollisionDraw::ZIG_ZAG, curCol);
                break;
            }
