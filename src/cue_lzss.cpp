...
unsigned char *LZS_Code(unsigned char *raw_buffer, unsigned int raw_len, unsigned int *new_len, unsigned int best);
...
void Lzss::encode(char *file) {
  LZS_Encode(file,LZS_VRAM);
}
